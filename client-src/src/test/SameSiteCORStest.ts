...
export async function activity() {
  ...
  console.assert(
    ...
    "Asset '/asset/shopping.es.min.mjs' has Access-Control-Request-Method:  = " +
      RET.headers.get("Access-Control-Request-Method")
  );
  console.assert(
    !RET.headers.get("access-control-allow-headers"),
    "Asset '/asset/shopping.es.min.mjs' Access-Control-Allow-Headers:  = " +
      RET.headers.get("Access-Control-Allow-Headers")
  );
  ...
  console.assert(
    ...
    "Asset '" +
      TEST_LOCATION_URL +
      "/asset/shopping.es.min.mjs' has Access-Control-Request-Method = " +
      RET.headers.get("Access-Control-Request-Method")
  );
  console.assert(
    !RET.headers.get("access-control-allow-headers"),
    "Asset '" +
      TEST_LOCATION_URL +
      "/asset/shopping.es.min.mjs' Access-Control-Allow-Headers = " +
      RET.headers.get("Access-Control-Allow-Headers")
  );
}
