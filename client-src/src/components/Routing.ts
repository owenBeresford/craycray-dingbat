...
export const StaticRoutes = createRouter({
  ...
  routes: [
    //  props: { name: 'attrs' }
    { path: "/list-all", name: "list-everything", component: ListOfLists, 
        props:(route) => { return { currentStateKey:"listoflists1", }; }  },
    { path: "/", name: "list-same", component: ListOfLists, 
        props:(route) => { return { currentStateKey:"listoflists2", }; } },
    { path: "/list/:index", name: "a-list", component: ThisList, 
          props: async (route) => { return { shopStore:useStore(), factory:await DataFactory(), currentStateKey:"thislist1", }; } },
