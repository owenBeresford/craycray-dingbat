...
import { DistantStorable, RemoteConfig } from "../types/RemoteTypes";
...
export class RemoteStorage implements Storable, DistantStorable {
  ...
  async loadState(): Promise<Array<SaveStruct>> {
