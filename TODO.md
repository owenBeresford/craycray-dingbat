> [!NOTE] 
> warning: Don't call lists "list X", or all the labelling gets confused "list list X".
...
- pour les mot variable privé, traduire en francias 
- ShoppingService test, add fixtures to extend load() testing
